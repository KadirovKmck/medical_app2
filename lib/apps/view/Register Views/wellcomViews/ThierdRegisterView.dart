...
class ThierdRegisterView extends StatefulWidget {
  const ThierdRegisterView({super.key});

  @override
  State<ThierdRegisterView> createState() => _ThierdRegisterViewState();
}

class _ThierdRegisterViewState extends State<ThierdRegisterView> {
  @override
